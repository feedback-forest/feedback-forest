  ...
  return (
    lectureInfo && (
      <div className="flex flex-col w-full desktop:w-[569px] tablet:w-[343px] mobile:w-[312px]">
        <div className="flex flex-col desktop:gap-[14px] tablet:gap-[13px] mobile:gap-6">
          <LectureSummaryHeader
            lectureInfo={lectureInfo}
            isLoading={isLoading}
          />
          <div className="flex flex-col">
            <div className="flex flex-col desktop:gap-4 tablet:gap-2.5 mobile:gap-3">
